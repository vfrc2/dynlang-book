...
\section{execute3DTask(TASK, ARG0, ARG1, ARGN, DLMAP) -> DLMap \textbar{} 
...
объект содержащий текущее состояние динамической формы в которой вызывается команда\tabularnewline
\bottomrule
\end{longtable}
